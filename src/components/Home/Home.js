    ...
    return (
        <main className="home">
            <header className="home-synopsis">
                ...
                <p>The album ends with the bonus section (Part III), which consists of two tracks I previously released that I would like new listeners to be familiar with (because I love them so much), as well as another new track.</p>
                <p>My hope is that this album fosters a continued interest in my music and my comedy (as well as the larger Nairobi stand-up comedy scene, which I've been a part of for over 18 months now). I hope you have as much fun listening to this album
                    as I had making it, and if it resonated with you, I hope you also share it with your friends and family.</p>
